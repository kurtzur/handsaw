  ...
  describe '::set_table/::table_name' do
    ...
    it '::table_name generates default name' do
     ...
     it'::columns creates getter methods for each column' do                    
       Cat.columns                                                              
       c = Cat.new                                                              
       expect(c.respond_to? :something).to be_falsey                           
       expect(c.respond_to? :name).to be_truthy                            
       expect(c.respond_to? :id).to be_truthy                                 
       expect(c.respond_to? :owner_id).to be_truthy                               
     end                                                                        
